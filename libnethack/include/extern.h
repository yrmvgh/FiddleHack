...
extern int use_pole(struct obj *, const struct nh_cmd_arg *);
...
extern int spec_dbon(struct obj *, struct monst *, int, int *);
...
extern void set_objpile(struct level *, int, int);
extern void unset_objpile(struct level *, int, int);
extern void update_objpile(struct level *, int, int);
...
extern void doaltarobj(struct monst *, struct obj *);
...
extern enum msg_channel combat_msgc(const struct monst *,
                                    const struct monst *,
                                    enum combatresult);
...
extern void rndcurse(struct monst *, struct monst *);
...
extern const char *oneattack(const struct attack *);
...
extern void win_list_items(struct nh_objlist *, boolean);
