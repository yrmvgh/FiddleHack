...
static const char *const maildelivery[] = {
    ...
    "An airy whisper, scented with lavender, arrives fluttering on a breeze, delivering the words of %s to you:  \"%s\"\n",
    ...
    "Buried deep in the core of your consciousness is a hazy memory of something %s may once have said: \"%s\"\n",
    ...
    "You summon your considerable mental powers and deliver unto %s a stunning rebuke.  The only reply is a feeble \"%s\"\n",
    "Emblazoned upon your mind like a brand, glowing like a hot iron, the hideous scrawled handwriting of %s says this: \"%s\"\n",
